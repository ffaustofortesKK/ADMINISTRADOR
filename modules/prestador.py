...
def listar_videos_pasta_clipes():
    ...
    # Pode expandir esta lista conforme a sua integração com Cloudinary
    return []
                    ...
                    st.markdown(f"""
                        <div style="background: rgba(0,0,0,0.95); border: 4px solid {cor_borda}; border-radius: 8px; padding: 12px 15px; margin-bottom: 10px; font-family: monospace;">
                            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 8px;">
                                <span style="font-weight: bold; font-size: 14px;">{badge_texto}</span>
                                <span style="font-size: 13px;">Cliente: <b>{cliente_nome}</b></span>
                            </div>
