...
def show_client_page():
    st.title("Página do Cliente / Pedidos")
...
frame_styles = """
<style>
    /* Estilos globais do frame */
</style>
"""

# -----------------------------------------------------------------------------
# FUNÇÃO PRINCIPAL DA TELA DO CLIENTE / TV (COM CONTAGEM + GRITO THRILLER)
# -----------------------------------------------------------------------------
...
def renderizar_ecra_tv(provider_token):
    try:
        ...
        if tocando_agora:
            url_video = tocando_agora.get('url', '')
            ...
            <div style="background: #000; width: 100%; height: 730px; display: flex; flex-direction: column; align-items: center; justify-content: center; position: relative; overflow: hidden;">
                ...
                <div id="karaoke-container" style="display: none; width: 100%; height: 100%; display: flex; flex-direction: column; align-items: center; justify-content: center;">
                    ...
                    <video id="karaoke-player" width="100%" height="620px" controls playsinline controlslist="nodownload noremoteplayback" disablepictureinpicture style="object-fit: contain; background: black; border-radius: 8px; border: 2px solid #FFC107;">
