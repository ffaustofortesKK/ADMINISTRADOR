...
# Constante global do Firebase 
FIREBASE_URL = "https://SEU-PROJETO-FIREBASE-DEFAULT-RTDBS.firebaseio.com"

# Barra lateral para alternar entre o Painel do Prestador e a TV
st.sidebar.title("🎛️ Navegação")
modo_visualizacao = st.sidebar.selectbox("Selecionar Vista", ["Painel do Prestador", "Ecrã TV"])
provider_token = st.sidebar.text_input("Token do Estabelecimento", value="token_exemplo_123")

# Executa o módulo correspondente de forma totalmente desacoplada
if modo_visualizacao == "Painel do Prestador":
    show_provider_panel_custom(provider_token, FIREBASE_URL)

elif modo_visualizacao == "Ecrã TV":
    renderizar_ecra_tv(provider_token, FIREBASE_URL)
